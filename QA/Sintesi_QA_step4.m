% per aggiungere dei vincoli proviamo allora a calcolare una soluzione per
% ottimizzazione 
...
%% risolvo il sistema di equazioni con un ottimizzazione vincolata
f2 = @(X)QA_by_9PT_for_fmincon(X,Points);
[x,eval] = fmincon(f2,X,[],[],[],[],lb,ub);
eval
x(1:9)'
